; ModuleID = '/home/benjamin/Grayscale_Soble/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_Sobel_ir(%"class.hls::stream"* %Data_In, %"class.hls::stream"* %Data_Out) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_Sobel_hw(%"class.hls::stream"* %Data_In_copy, %"class.hls::stream"* %Data_Out_copy)
...
declare void @apatb_Sobel_hw(%"class.hls::stream"*, %"class.hls::stream"*)

define void @Sobel_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @Sobel_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @Sobel_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*)
