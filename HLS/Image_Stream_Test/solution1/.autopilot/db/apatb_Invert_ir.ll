; ModuleID = '/home/benjamin/Image_Stream_Test/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

%"class.hls::stream" = type { %"struct.hls::axis" }
%"struct.hls::axis" = type { %struct.ap_uint, %struct.ap_uint.0, %struct.ap_uint.0, %struct.ap_uint.3, %struct.ap_uint.6, %struct.ap_uint.9, %struct.ap_uint.12 }
...
%struct.ssdm_int.11 = type { i5 }
%struct.ap_uint.12 = type { %struct.ap_int_base.13 }
%struct.ap_int_base.13 = type { %struct.ssdm_int.14 }
%struct.ssdm_int.14 = type { i6 }

; Function Attrs: noinline
define void @apatb_Invert_ir(%"class.hls::stream"* %Data_In, %"class.hls::stream"* %Data_Out) local_unnamed_addr #0 {
entry:
  %Data_In_copy = alloca %"class.hls::stream", align 512
  %Data_Out_copy = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %Data_In, %"class.hls::stream"* nonnull align 512 %Data_In_copy, %"class.hls::stream"* %Data_Out, %"class.hls::stream"* nonnull align 512 %Data_Out_copy)
  call void @apatb_Invert_hw(%"class.hls::stream"* %Data_In_copy, %"class.hls::stream"* %Data_Out_copy)
  call fastcc void @copy_out(%"class.hls::stream"* %Data_In, %"class.hls::stream"* nonnull align 512 %Data_In_copy, %"class.hls::stream"* %Data_Out, %"class.hls::stream"* nonnull align 512 %Data_Out_copy)
  ret void
}
...
; <label>:94:                                     ; preds = %91, %90, %86, %82
  ...
  %95 = bitcast %struct.ap_uint.12* %.0.650 to i8*
...
; <label>:98:                                     ; preds = %94
  ...
  %99 = bitcast %struct.ap_int_base.13* %.0.6.052 to i8*
...
; <label>:102:                                    ; preds = %98
  ...
  %103 = bitcast %struct.ssdm_int.14* %.0.6.0.054 to i8*
...
declare void @apatb_Invert_hw(%"class.hls::stream"*, %"class.hls::stream"*)

define void @Invert_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @Invert_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @Invert_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*)
