...
# 3 "Downloads/example_hls.cpp" 2
# 13 "Downloads/example_hls.cpp"
__attribute__((sdx_kernel("Invert", 0))) void Invert(hls::stream< ap_axis<32,2,5,6>> &Data_In, hls::stream<ap_axis<32,2,5,6>> &Data_Out){
#pragma HLS TOP name=Invert
# 13 "Downloads/example_hls.cpp"
...
#pragma hls interface s_axilite port=return
 ...
 VITIS_LOOP_28_1: while(1){
  ...
  Data_Out.write(tmp);
# 58 "Downloads/example_hls.cpp"
  if(tmp.last){
   break;
  }

 }
# 85 "Downloads/example_hls.cpp"
}
